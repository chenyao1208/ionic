...
export class Nav implements NavOutlet {
  ...
  private queueTrns(
    ...
    if (this.isTransitioning && ti.opts != null && ti.opts.skipIfBusy === true) {
  ...
  private async runTransition(ti: TransitionInstruction) {
    try {
      ...
      const result = requiresTransition === true
  ...
  private postViewInit(
    ...
    if (insertViews) {
      ...
      if (ti.enteringRequiresTransition === true) {
  ...
  private async transition(
    ...
    const progressCallback = opts.progressAnimation === true
      ? (animation: Animation) => {
